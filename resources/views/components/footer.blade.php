<footer>
    <div class="bg-[#1A2D98] pt-70 min-h-[65vh] relative md:pt-50">
        <div
             class="flex w-full flex-col md:flex-row min-h-[40vh] justify-between lg:w-[1000px] bg-[#2038BF] absolute -top-1/3 left-1/2 -translate-x-1/2  px-10 pt-10 rounded-[20px]">
        ...
        <div
             class="lg:w-[1000px] mx-auto flex flex-col items-center  md:flex-row md:justify-between md:items-start md:px-10 lg:px-0">
            <div class="w-[40%] space-y-4">
                <h4 class="text-white text-lg font-extrabold">PLEXUS MEDICAL CITY</h4>
            ...
            <div class="space-y-4">
                <h4 class="text-white text-lg font-extrabold">Quick Links</h4>
                <div class="flex flex-col text-white/90 space-y-2">
                    <a href="">Home</a>
                    <a href="">About Us</a>
                    <a href="">Contact Us</a>
                </div>
            ...
            <div class="space-y-4">
                <h4 class="text-white text-lg font-extrabold">Support</h4>
                <div class="flex flex-col text-white/90 space-y-2">
    ...
    <div class="flex justify-between items-center lg:w-[1000px] mx-auto text-xs min-h-[5vh]">
        <div class="flex items-center space-x-1">
            <img class="w-[15px]" src="{{ asset('/assets/images/ic_baseline-copyright.svg') }}" alt="copy right icon">

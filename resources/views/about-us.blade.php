<x-main-layout>
    <section
        ...
        <div class="md:w-[80%] mx-auto flex justify-between items-start"  >
            <div class="lg:bg-white lg:rounded-[20px] px-4 lg:px-10 py-8 lg:w-[60%] space-y-5">
                <h1 class="font-[Calligraffitti] text-6xl text-center md:text-left text-white md:text-black" data-aos="fade-up" data-aos-duration="1000">About us</h1>
                <p class="leading-7 text-white/90 md:text-black/90" data-aos="fade-up" duration="1500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis itaque error
                    voluptatibus modi
                ...
                <div class="space-y-4">
                    <div data-aos="fade-up" duration="1500" class="flex space-x-5 px-4 py-4 shadow-sm  text-black/80 rounded-[20px] bg-[#ADD8E633]">
    ...
    <section class="px-4 md:px-0 min-h-[140vh] bg-[#707FA5] py-16 text-center ">
        <h1 class="text-6xl font-[Calligraffitti] text-white" data-aos="fade-up" duration="1000">History</h1>
        <div class="flex ">
            <div class="mt-14 space-y-16">
                <div data-aos="fade-up" duration="1500" class="md:w-[60%] text-white/80 rounded-[20px] px-5 py-10 bg-[#132272] mx-auto">Lorem ipsum dolor
                ...
                <div data-aos="fade-up" duration="1500"
    ...
    <section
             class="px-4 md:px-0 bg-[url(/public/assets/images/d327099868ff2a0e580ee2a61d2c36c5-removebg-preview1.svg)] bg-contain min-h-[140vh] py-16">
        <div class="lg:max-w-[80%] mx-auto space-y-16">
            <h1 class="text-6xl font-[Calligraffitti] text-center" data-aos="fade-up" data-aos-duration="1000">Strategic Plan and Roadmap</h1>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[]">
                <div  class="border rounded-[20px] px-10 md:px-16 py-6 bg-[#0E87CC] text-white space-y-4">
    ...
    <section class="bg-[#bbc0cecc] min-h-[140vh] py-16">
        <div class="lg:max-w-[80%] mx-auto space-y-20 md:space-y-10">
            <h1 data-aos="fade-up" data-aos-duration="1000" class="text-5xl text-wrap font-[calligraffitti] text-center">Implementation and Operational Management
            </h1>
    ...
    <section class="min-h-[130vh] py-16">
        <div class="md:max-w-[85%] mx-auto space-y-16">
            <h1 data-aos="fade-up" data-aos-duration="1000" class="font-[calligraffitti] text-5xl/20 text-center text-wrap lg:max-w-[50%] mx-auto py-16 bg-white">
                Global
                Partnership, Medical
    ...
    <section class="min-h-[130vh] bg-[#1A2D98E5] py-20">
        <div class="max-w-[80%] mx-auto space-y-20">
            <h1 class="text-5xl font-[calligraffitti] text-center text-white" data-aos="fade-up" data-aos-duration="1000">Budget Summary</h1>
    ...
    <section class="min-h-[150vh]">
        <div class="px-4 md:px-0 py-16 bg-[#0E87CC4D] space-y-16">
            <h1 class="lg:max-w-[38%] text-5xl/20 font-[calligraffitti] mx-auto text-center" data-aos="fade-up" data-aos-duration="1000">Financial Sustainability
                and
                Long-Term Growth</h1>
            <div class="space-y-20">
                ...
                <div
                    ...
                    <ul class="list-disc list-inside space-y-2 pl-8 font-extrabold text-black/80">
                        <li>
